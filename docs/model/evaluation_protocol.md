...
The official full lifecycle archive was downloaded, SHA-256 verified and extracted on 2026-09-13. `Bearing1_1` has a first lifecycle sanity plot with 123 one-minute snapshots. This passes the data-access gate, but not the RUL-evidence gate.
